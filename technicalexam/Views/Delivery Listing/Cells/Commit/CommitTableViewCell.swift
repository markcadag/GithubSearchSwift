...
class CommitTableViewCell: BaseTableViewCell {
    ...
    // MARK: - Properties
    static var identifier: String = "CommitTableViewCell"
    ...
    internal func setupCell(_ viewModel: CommitViewModel) {
        labelTitle.text = viewModel.repoName
        labelLocation.text = viewModel.message
